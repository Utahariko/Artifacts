...
- Suzerain-like panel layout

## Next good iteration

- replace condensed chapter text with the full production-package text from the Word specification
- add more conditional variations triggered by prior flags
- refine typography and spacing after visual browser review
